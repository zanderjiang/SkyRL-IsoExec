...
# Only deviations from defaults are set here. Build the runtime first: build_isoexec_env.sh
set -euo pipefail
...
export SKYRL_ISOEXEC_GDN=1 SKYRL_ISOEXEC_GDN_KERNEL=cpr SKYRL_ISOEXEC_GDN_NATIVE_KERNELS=1
export SKYRL_ISOEXEC_GDN_CHUNKED_PREFILL=1 SKYRL_ISOEXEC_GDN_CPR_MIN_PAGES=1 SKYRL_ISOEXEC_GDN_CPR_SLEEP=1
